...
public:
	...
	const std::string getString(const std::string& name){return getString(name, "", false);}
	const std::string getString(const std::string& name, const std::string& defaultValue, const bool useDefault = true);
